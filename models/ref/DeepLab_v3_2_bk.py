...
class Atrous_ResNet_features(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, rate=2):
        downsample = None
...
class DeepLabv3(nn.Module):
    def __init__(self, num_classes=1, small=True, pretrained=True):
        ...
        self.fc1 = nn.Sequential(nn.Conv2d(1280, 256, kernel_size=1),nn.BatchNorm2d(256),nn.ReLU(inplace=True))
