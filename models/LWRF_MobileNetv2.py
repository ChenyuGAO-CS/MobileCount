...
class MobileNetLWRF(nn.Module):
    ...
    def __init__(self, num_classes=1, pretrained=False):
        ...
        self.p_ims1d2_outl1_dimred = conv1x1(256, 256, bias=False)
        ...
        self.p_ims1d2_outl2_dimred = conv1x1(128, 128, bias=False)
        self.adapt_stage2_b2_joint_varout_dimred = conv1x1(128, 128, bias=False)
        self.mflow_conv_g2_pool = self._make_crp(128, 128, 4)
        self.mflow_conv_g2_b3_joint_varout_dimred = conv1x1(128, 64, bias=False)

        self.p_ims1d2_outl3_dimred = conv1x1(64, 64, bias=False)
        self.adapt_stage3_b2_joint_varout_dimred = conv1x1(64, 64, bias=False)
        self.mflow_conv_g3_pool = self._make_crp(64, 64, 4)
        self.mflow_conv_g3_b3_joint_varout_dimred = conv1x1(64, 32, bias=False)
